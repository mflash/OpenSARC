<%@ Page Language="C#" MasterPageFile="~/Master/MasterBootstrap.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Alocacoes_Default" Title="Sistema de Alocação de Recursos - FACIN" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div align="left" style="width: 100%; height: 14px">
                <asp:Label ID="lblDisciplina" runat="server" CssClass="ms-WPTitle" Text="VISUALIZAR RECURSOS ALOCADOS POR:"></asp:Label>
            </div>
            <asp:RadioButtonList ID="rblAlocacoes" runat="server" OnSelectedIndexChanged="rblAlocacoes_SelectedIndexChanged" AutoPostBack="True" BackColor="White" BorderColor="White" CssClass="ms-toolbar">
                ...
                <asp:ListItem>Turma</asp:ListItem>
            </asp:RadioButtonList>
            <table id="Table3">
                <tr>
                    <td style="width: 56px; height: 26px" class="ms-toolbar">
                        <asp:Label runat="server" ID="lblData" Text="Data"/></td>
            ...
            <asp:Panel ID="pnlVisualizarPorCategoria" runat="server" Height="50px"
                ...
                <table id="Table2">
                    <tr>
                        <td style="width: 88px; height: 26px" class="ms-toolbar">Categoria</td>
            ...
            <asp:Panel ID="pnlVisualizarPorRecurso" runat="server" Height="50px"
                ...
                <table id="Table2b">
                    <tr>
                        <td style="width: 88px; height: 26px" class="ms-toolbar">Recurso</td>
                        <td style="height: 26px; width: 173px;">
                            <ajaxToolkit:ComboBox ID="cbRecurso" runat="server" AutoCompleteMode="SuggestAppend" CssClass="ms-toolbar" Width="500px"/>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            <asp:Panel ID="pnlVisualizarPorHorario" runat="server" Height="50px"
                ...
                <table id="Table2">
                    ...
                    <tr>
                        <td style="width: 88px; height: 26px" class="ms-toolbar">Horário</td>
                        <td style="height: 26px; width: 173px;">
            ...
            <asp:Panel ID="pnlVisualizarPorProfessor" runat="server" Height="50px"
                ...
                <table id="Table1">
                    <tr>
                        <td style="width: 84px; height: 26px" class="ms-toolbar">Professor</td>
                        <td style="height: 26px">
                            <ajaxToolkit:ComboBox ID="cbProfessor" runat="server" AutoCompleteMode="SuggestAppend" CssClass="ms-toolbar" Width="500px"/>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            <asp:Panel ID="pnlVisualizarPorSecretario" runat="server" Height="50px"
                ...
                <table id="Table4">
                    <tr>
                        <td style="width: 84px; height: 26px" class="ms-toolbar">Secretário</td>
                        <td style="height: 26px">
            ...
            <asp:Panel ID="pnlVisualizarPorTurma" runat="server" Height="50px" Width="125px" Visible="False">
                <table id="Table5">
                    <tr>
                        <td style="width: 84px; height: 26px" class="ms-toolbar">Turma</td>
                        <td style="height: 26px">
                            <ajaxToolkit:ComboBox ID="cbTurma" runat="server" AutoCompleteMode="SuggestAppend" CssClass="ms-toolbar" Width="500px" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
