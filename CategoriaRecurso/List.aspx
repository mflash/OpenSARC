<%@ Page Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true"
 CodeFile="List.aspx.cs" Inherits="CategoriaRecurso_List" Title="Sistema de Alocação de Recursos - FACIN" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphTitulo">
    ...
    <asp:Label ID="lblTitulo" runat="server" CssClass="ms-WPTitle" Text="LISTA DE CATEGORIAS DE RECURSOS"></asp:Label></div>
...
<TR>
<TD>
<asp:GridView id="grvListaRecursos" runat="server" AutoGenerateColumns="False"
 Width="636px" 
 OnRowDeleting="grvListaRecursos_RowDeleting" OnRowEditing="grvListaRecursos_RowEditing" 
...
<AlternatingRowStyle CssClass="linhaAlternadaTabela"></AlternatingRowStyle>
 ...
 runat="server" CssClass="lblstatus"></asp:Label></TD></TR><TR><TD colSpan=1 rowSpan=1>
