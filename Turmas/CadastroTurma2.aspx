...
<TABLE style="WIDTH: 510px" align=left><TBODY><TR><TD style="WIDTH: 20px; HEIGHT: 26px" class="ms-toolbar">Disciplina:</TD><TD style="WIDTH: 267px; HEIGHT: 26px">            
    ...
    </TD></TR><TR><TD style="WIDTH: 20px; HEIGHT: 16px" class="ms-toolbar">Número:</TD><TD style="WIDTH: 267px; HEIGHT: 16px"><asp:TextBox id="txtNumero" runat="server" CssClass="ms-toolbar" Width="200px"></asp:TextBox>
