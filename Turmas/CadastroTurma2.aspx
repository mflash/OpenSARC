...
<asp:Content ID="phTitulo" runat="server" ContentPlaceHolderID="cphTitulo">
    <div align = left class="ms-menutoolbar" style="width: 100%; height: 14px">
        <asp:Label ID="Label6" runat="server" CssClass="ms-WPTitle" Text="CADASTAR TURMA"></asp:Label></div>
...
<TABLE style="WIDTH: 510px" align=left><TBODY><TR><TD style="WIDTH: 20px; HEIGHT: 26px" class="ms-toolbar">Disciplina:</TD><TD style="WIDTH: 267px; HEIGHT: 26px"><asp:DropDownList id="ddlDisciplina" runat="server" CssClass="ms-toolbar">
                    ...
                    <asp:RegularExpressionValidator id="revDataHora" runat="server" ControlToValidate="txtDataHora" ValidationExpression="([2-7][A-N|P|X]{1,2}[\s]{0,1})+" ErrorMessage="Formato de Data & Hora inválido!" CssClass="ms-toolbar">*</asp:RegularExpressionValidator></TD></TR><TR><TD style="WIDTH: 20px; HEIGHT: 16px" class="ms-toolbar">Professor:</TD><TD style="WIDTH: 267px; HEIGHT: 16px"><asp:DropDownList id="ddlProfessor" runat="server" CssClass="ms-toolbar" Width="200px">
                ...
                </asp:DropDownList></TD></TR><TR><TD style="WIDTH: 20px; HEIGHT: 26px"><asp:Button id="btnConfirmar" onclick="btnConfirmar_Click" runat="server" CssClass="ms-toolbar" Text="Confirmar" Width="79px" Height="20px" Font-Size="10px"></asp:Button></TD><TD style="WIDTH: 267px; HEIGHT: 26px">&nbsp;</TD></TR><TR><TD style="HEIGHT: 26px" colSpan=2><asp:Label id="lblStatus" runat="server" CssClass="lblstatus" Visible="False"></asp:Label></TD></TR></TBODY></TABLE>
</ContentTemplate>
                    <Triggers>
