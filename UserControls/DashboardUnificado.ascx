<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DashboardUnificado.ascx.cs" Inherits="UserControls_DashboardUnificado" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        ...
        <div class="container-fluid py-1" runat="server" id="container" visible="true">
