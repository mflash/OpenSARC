...
CodeFile="List.aspx.cs" Inherits="CategoriaDisciplina_List" Title="Sistema de Alocação de Recursos - FACIN" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphTitulo">
    ...
    <asp:Label ID="lblTitulo" runat="server" CssClass="ms-WPTitle" Text="LISTA DE CATEGORIAS DE DISCIPLINAS"></asp:Label></div>
...
<TBODY><TR><TD ><asp:GridView id="grvListaDisciplinas" runat="server" AutoGenerateColumns="False" Width="636px" DataKeyNames="Id" OnRowDeleting="grvListaDisciplinas_RowDeleting" OnRowEditing="grvListaDisciplinas_RowEditing"><Columns>
...
</asp:GridView> </TD></TR><TR><TD style="WIDTH: 292px" colSpan=1 rowSpan=1><asp:Label id="lblStatus" runat="server" CssClass="lblstatus"></asp:Label></TD></TR><TR><TD style="WIDTH: 292px" colSpan=1 rowSpan=1><asp:LinkButton id="lbtnVoltar" runat="server" CssClass="ms-toolbar" OnClick="lbtnVoltar_Click">Voltar</asp:LinkButton></TD></TR></TBODY></TABLE>
</ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
