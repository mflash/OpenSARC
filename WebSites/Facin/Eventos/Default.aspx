<%@ Page Language="C#" MasterPageFile="~/Master/Master.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Eventos_Default" Title="Cadastrar Evento" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitulo" runat="Server">
    <div align = "left" class="ms-menutoolbar" style="width: 100%; height: 14px">
        <asp:Label ID="lblTitulo" runat="server" CssClass="ms-WPTitle" Text="CADASTRAR EVENTO"></asp:Label>
    </div>
            ...
            <table style="width: 415px">
                ...
                <tr>
                    ...
                    <td colspan="2" style="width: 317px; height: 22px">
                        <asp:CheckBox ID="ckbEhRecorrente" runat="server" AutoPostBack="True" Text="Tornar Recorrente" OnCheckedChanged="ckbEhRecorrente_CheckedChanged" CssClass="ms-toolbar" /></td>
                </tr>
                <tr>
                    <td style="width: 98px; height: 9px;">
                    </td>
                    <td style="height: 9px; width: 98px;">
                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" Visible="false" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" AutoPostBack="True" CssClass="ms-toolbar" Width="124px">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <asp:ImageButton ID="imgbtnDataFim" runat = "server" ImageUrl="~/_layouts/images/CALENDAR.GIF" CausesValidation="False" /><asp:RequiredFieldValidator
                            ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDataFim" CssClass="ms-toolbar"
                            ErrorMessage="Digite uma data.">*</asp:RequiredFieldValidator>
