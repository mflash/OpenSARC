...
CodeFile="ListaSecretarios.aspx.cs" Inherits="Secretarios_ListaSecretarios" Title="Sistema de Alocação de Recursos - FACIN" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphTitulo">
    ...
    <div align="left" class="ms-menutoolbar" style="width: 100%; height: 14px">
        <asp:Label ID="lblListaSecs" runat="server" CssClass="ms-WPTitle" Text="LISTA DE SECRETÁRIOS"></asp:Label></div>
...
<TR>
<TD>
<asp:GridView id="grvListaSecretarios" 
runat="server" AutoGenerateColumns="False" Width="636px" AllowSorting="True" DataKeyNames="Id"
 OnRowDeleting="grvListaSecretarios_RowDeleting" OnRowEditing="grvListaSecretarios_RowEditing">
 <Columns>
