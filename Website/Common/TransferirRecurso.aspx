<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferirRecurso.aspx.cs" Inherits="Secretarios_TransferirRecurso" %>
  ...
  if (confirm("Tem certeza que deseja transferir este recurso?")==true)
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
            <asp:Panel ID="pnlgeral" runat="server" Width="350" Height="220" ScrollBars="Auto">
                <table>
                    <tr>
                        <td >
